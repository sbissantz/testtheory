...
- Zusätzlich: Wichtig, dass Sie SPF mit der Hand ausrechnen können. 
1. Aufgabe: Ausrechnen
2. Mit R überprüfen
3. An der Tafel zeigen


### Voraussetzungen: Test-Test Reliabilitäten 

- Messung einer einzigen latenten Variable: Eindimensionalität 
(d.h., keine Fehlerkovarianzen -- Voraussetzung für die Eindimensionalität[^4])
...
[^4]: Prüfung der Annahme "Eindimensionalität" bitte anhand einer CFA. Siehe
