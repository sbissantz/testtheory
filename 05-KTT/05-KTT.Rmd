...
d.h. man ist häufig dazu "verdammt", latente Konstrukte mit Messfehler zu
erfassen.
\end{block}
...
## Warum unsystematische Einflüsse?
...
abline(v=67, lty=2)
mtext("Verteilung der Messergebnisse")
```

## Übungsaufgabe 1: Prognose & Selbstexperiment
 
- Wie verändert sich die Ergebniss mit steigender Wiederholungszahl? 
- Ab wann sind die Veränderungen konstant?

\begin{example}
Versuchen Sie es selbst! Nutzen Sie den Code auf den vorherigen Folien. Geben Sie
ihr eigenes Alter/Gewicht ein und verändern Sie den Wert für \texttt{n}.
\end{example}

Anmerkungen: Sie sollen die Konzepte *nicht* jede Zeile des Codes verstehen!
...
## Übungsaufgabe 2: Prognose & Selbstexperiment
...
## Übungsaufgabe 3: Prognose & Selbsttests
...
Anmerkung: Um unsere Ergebnisse zu reproduzieren -- \texttt{set.seed(123)}
...
## Übungsaufgabe 4: Prognose & Selbsttest
...
## Übubngsaufgabe 5: Prognose & Selbsttest
...
# Selbststudium: Zum Problem(?) systematischer Störeinflüsse
