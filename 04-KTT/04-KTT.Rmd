...
Formale Darstellung der Bürde der Messung komplexer Phänomene..
...
\begin{example}
Versuchen Sie es selbst! Nutzen Sie den Code auf den vorherigen Folie. Geben Sie
ihr eigenes Alter/Gewicht ein und verändern Sie den Wert für \texttt{n}. Wie
verändert sich der Wert mit steigender Wiederholungszahl? Ab wann sind die
