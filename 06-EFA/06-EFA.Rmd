...
Fokus (heute): Common Factor Model (CFM)
...
- $\Lambda$: $m \times p$ Matrix der Item-Faktor Korrelationen (Ladung)
- $\xi$: Faktoren ($p$ Stück)
...
## "Playing Creator": 2 LVs erschaffen[^2] 
...
können wir prüfen, ob unsere Methoden das "korrekte" Ergebnis reproduzieren.
...
enstprechenden Kennwerte für ihr Modell und präsentieren Sie diese ihrem
Nachbarn.
\end{example}
...
wie plausibel halten Sie diese Annahme? Diskutieren Sie miteinander!
\end{example}
...
Zusatz: Sie kennen das "richtige" Ergebnis. Wir haben die Antowrten immerhin
simuliert. Welche Lösung kommt ihren Ergebnissen am nächsten? 
...
$H_0$: Ist die zu faktorisierende Korrelationsmatrix signifikant von einer
