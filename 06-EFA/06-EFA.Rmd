...
## Vorbereitung: "Playing Creator" -- 2 LVs erschaffen
...
unterschiedliche Basisannahmen. Dennoch werden sie häufig in der Literatur unter
dem Deckmantel "explorative Faktorenanalyse" vereinheitlicht. Als Randnotiz die
Modellgleichungen: $R = CC^{t}$ (PCA), $R^* = FF^{t}$ (PAF), $P = \Lambda
\Phi \Lambda^{t} + \Psi$ (CFM). Für die psychologische Praxis scheint das CFM am
wenigsten restriktiv.
...
## Übungsaufgabe 4: Kritische Reflexion & Diskussion
...
Konstrukte unabhängig voneinander sein müssten. Für wie plausibel halten Sie
diese Annahme in der Psychologie? Diskutieren Sie miteinander!
\end{example}
...
- MLF bietet nun als Lösung die plausibelsten (eng. "most likely") Werte zur
